 ...
 */
define(['./myWidget', 'esri/map', 'esri/dijit/Search', 'esri/layers/FeatureLayer', 'esri/InfoTemplate', 'esri/SpatialReference', 'esri/geometry/Extent', 'dojo/domReady!'],
  function (myWidget, Map, Search, FeatureLayer, InfoTemplate, SpatialReference, Extent) {
    var app = {};
